...
export const DEFAULT_BUILD_PLANS: Record<string, DefaultBuildPlan> = {
  E58S28: {
    plan: [
      ...
      { x: 45, y: 27, structureType: STRUCTURE_RAMPART },
      ...
      { x: 30, y: 29, structureType: STRUCTURE_RAMPART },
  ...
  E59S28: {
    plan: [
      ...
      { x: 37, y: 21, structureType: STRUCTURE_RAMPART },
      { x: 36, y: 21, structureType: STRUCTURE_RAMPART },
      ...
      { x: 18, y: 14, structureType: STRUCTURE_RAMPART },
  ...
  E59S29: {
    plan: [
      ...
      { x: 17, y: 19, structureType: STRUCTURE_RAMPART },
