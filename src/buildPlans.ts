...
export const DEFAULT_BUILD_PLANS: Record<string, DefaultBuildPlan> = {
  ...
  E58S29: {
    plan: [
      ...
      // { x: 3, y: 46, structureType: STRUCTURE_WALL },
      // { x: 2, y: 42, structureType: STRUCTURE_WALL },
      // { x: 1, y: 40, structureType: STRUCTURE_WALL },
      // { x: 1, y: 41, structureType: STRUCTURE_RAMPART },
      // { x: 1, y: 42, structureType: STRUCTURE_RAMPART },
      // { x: 3, y: 45, structureType: STRUCTURE_RAMPART },
      // { x: 2, y: 34, structureType: STRUCTURE_RAMPART },
      // { x: 1, y: 34, structureType: STRUCTURE_WALL },
